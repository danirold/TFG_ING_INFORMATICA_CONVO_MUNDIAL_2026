...
async def descargar_convocatoria_pdf(datos: PeticionDescargaPDF):
    try:
        ...
        def dibujar_fila(jugador, es_titular):
            ...
            # LIMPIEZA CLAVE: Eliminamos saltos de línea ocultos y limitamos a 27 caracteres
        ...
        for pos_key, pos_name in pos_map.items():
            ...
            if jugadores_pos:
                ...
                # NUEVO: Control de salto de página para no dejar títulos huérfanos
                if pdf.get_y() > 240:
                    pdf.add_page()
        ...
        # --- SECCIÓN RESERVAS ---
        # NUEVO: Comprobamos el espacio antes del bloque de Reservas
        if pdf.get_y() > 230:
            pdf.add_page()
